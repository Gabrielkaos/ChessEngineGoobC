...
//const int sideToMoveBonus=2;
//const int outposts=9;
//const int semi_outposts=8;
...
int EvalPosition(const S_BOARD *pos){
        ...
        if(pce==EMPTY){
            ...
            case wN:
                ...
                if(filesBoard[sq]>FILE_A && filesBoard[sq] < FILE_H){
                    if(pos->pieces[sq-7]==wP || pos->pieces[sq-9]==wP ){
            ...
            case bN:
                ...
                //semi outposts
                if(filesBoard[sq]>FILE_A && filesBoard[sq] < FILE_H){
                    if((pos->pieces[sq+7]==bP || pos->pieces[sq+9]==bP )){
            ...
            case wK:
                ...
                if(isEndGameWhite){
                    ...
                    if(filesBoard[sq]==FILE_G && ranksBoard[sq]==RANK_1){
                        if(!(GETBIT(pos->bitboards[wP],(sq+8)))&&
            ...
            case bK:
                ...
                if(isEndGameBlack){
                    ...
                    if(filesBoard[sq]==FILE_G && ranksBoard[sq]==RANK_8){
                        if(!(GETBIT(pos->bitboards[bP],(sq-8))) &&
    ...
    //bishop pair
    if(pos->numPieces[wB]>=2)score+=bishopPair;
    if(pos->numPieces[bB]>=2)score-=bishopPair;
