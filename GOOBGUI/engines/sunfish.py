...
class Position(namedtuple('Position', 'board score wc bc ep kp')):
    ...
    # def gen_moves(self, returnQueue):
    #     lists = []
...
class Searcher:
    ...
    def search(self, pos, history=()):
        ...
        for depth in range(1, MAXDEPTH+1):
            ...
            # return depth2,self.tp_move.get(pos), self.tp_score.get((pos, depth2, True)).lower
...
def main():
    ...
    while True:
        ...
        for depth, move, score in searcher.search(hist[-1], hist):
            print(f"{depth} {render(119-move[0]) + render(119-move[1])} {score} {iterations}")
        ...
        print("\nMy move:", render(119-move[0]) + render(119-move[1]))
        hist.append(hist[-1].move(move))
